          ...
          <section className='image-link'>
            ...
            <div className='project-title'>
              <ul>
                <li>Fitness app</li>
                <li>
                  This is app was created to keep track of food journal entries
                  and recommended workout programs based on difficulty level
                </li>
                <li>
                  A user registers and after logging in will be prompted to
                  choose a workout based on the level of difficulty they would
                  like to do
                </li>
                <li>
                  Each difficulty has a name, description, video associated to
                  the workout, recommended sets and reps, and prompt to enter
                  the users reps per set
                </li>
                <li>
                  The users entered reps will be stored and show on the bottom
                  of the exercise pages for the user
                </li>
                <li>
                ...
                <li>
                  Food journal entries will display for the user at the bottom
                  of the page and give an option to delete an entry
                </li>
              </ul>
            </div>
          </section>
          <div className='bottom-images'>
            <img src={SchemaDiagram} alt='Do You Even Lift Bro?' />
          </div>
        </main>
      </body>
    </>
