        ...
        <section className='image-link'>
          ...
          <div className='project-title'>
            <p>
              ...
              digital books, offering a comprehensive platform where readers can
              explore, discover, and engage with a vast array of literary
            ...
            <p>
              ...
              showcases the richness of the library's content but also enhances
              the user journey from start to finish. With a focus on intuitive
              navigation, personalized recommendations, and interactive
              features, we're committed to creating a digital space where users
              can lose themselves in the world of literature.
            </p>
          </div>
        </section>
      </main>
