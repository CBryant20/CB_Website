        ...
        <main className='projects'>
          <section className='image-link'>
            ...
            <div className='project-title'>
              <p>
                Connect Hub is a web-based application designed for
                communication between users and admin. It serves as a platform
                where users can create accounts, log in, and send text messages.
                The app combines design with secure communication, providing
                users with a way to interact with designated personnel.
              </p>
              <ul>
                <h3>Key Features</h3>
          ...
          <div className='bottom-images'>
            <img src={ChatImage} alt='Do You Even Lift Bro?' />
          </div>
        </main>
      </body>
    </>
